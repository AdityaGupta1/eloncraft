...
public class FluidDisplay extends Gui {
    ...
    public FluidDisplay(int x, int y, FluidTank tank, boolean outline, boolean drawTextNextTo) {
        this.setData(x, y, tank, outline, drawTextNextTo);
    }

    public FluidDisplay(int x, int y, FluidTank tank) {
        this(x, y, tank, false, false);
    }

    public void setData(int x, int y, FluidTank tank, boolean outline, boolean drawTextNextTo) {
        this.x = x;
        this.y = y;
        this.tank = tank;
