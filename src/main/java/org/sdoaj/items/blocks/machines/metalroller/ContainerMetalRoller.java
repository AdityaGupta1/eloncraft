...
public class ContainerMetalRoller extends Container {
    ...
    public ContainerMetalRoller(InventoryPlayer inventory, TileEntityBase tileEntity) {
        ...
        this.addSlotToContainer(new SlotItemHandlerUnconditioned(this.tileEntity.inv, TileEntityMetalRoller.SLOT_INPUT_1, 80, 21));
        this.addSlotToContainer(new SlotOutput(this.tileEntity.inv, TileEntityMetalRoller.SLOT_OUTPUT_1, 66, 69));
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slotId) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotId == TileEntityMetalRoller.SLOT_OUTPUT_1) {
            ...
            // exclude other slots in inventory
                ...
                if (MetalRollerRecipes.getRecipeFromInput(newStack) != null) {
                    if (!this.mergeItemStack(newStack, TileEntityMetalRoller.SLOT_INPUT_1, TileEntityMetalRoller.SLOT_INPUT_1 + 1, false)) {
                        return ItemStack.EMPTY;
                    }
                }
